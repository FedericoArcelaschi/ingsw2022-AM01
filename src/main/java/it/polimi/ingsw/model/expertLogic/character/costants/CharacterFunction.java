...
import it.polimi.ingsw.model.expertLogic.BlockedIsland;
...
import it.polimi.ingsw.model.expertLogic.influence.professor.ProfessorsMapComputingFunctions;
...
enum CharacterFunction {
    ...
    GUARD(
        ...
        -> {
            ...
            //find next and previous with a stupid ArrayList.
                if (islandIndex == 0) {
            ...
            //islands are joined
                ...
                if (islandToJoin.size() == 2) {
                    if (islandList.removeAll(islandToJoin))
